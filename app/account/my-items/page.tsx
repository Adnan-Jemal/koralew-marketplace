...
export default async function page() {
  ...
  return (
    <div className="flex flex-wrap gap-6 items-center justify-around p-10">
      {userItems?.map((item)=><ItemCard title={item.product.title} imageUrl={item.product_images.imageUrl} price={parseFloat(item.product.price)} condition={item.product.condition} />)}
      {/* <ItemCard
